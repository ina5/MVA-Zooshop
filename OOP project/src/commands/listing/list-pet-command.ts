...
export class ListPet implements ICommand {
    ...
    public execute(parameters: string[]): string {
        ...
        if (petArray === undefined) {
            ...
            return searchAnimalByPriceCriteria(petArray, criteria, +animalPrice);
        }
        // NEED TO BE PRIVATE STATIC METHOD!
        function searchAnimalByPriceCriteria(petFoundArray: IPet[], byCriteria: string, price: number): string {
